...
public class Graphs_BranchWiseFieldInvestigation  extends Utils {
    ...
    By Status_Type_FieldInvestigation = By.xpath("//*[@id=\"graphTypeOptions\"]//*[text()='Branch Wise Field Investigation']");
    ...
    public void BranchwiseFI_7DaysFilter()
    {
...
//        click(custom_month_CollectionTrend);
    ...
    public void clickDownloadCSVButton() throws IOException, CustomException {
        ...
        wait(5);
        String downloadFolderPath = "src/file_download";  // Replace with the actual folder path
        String fileName = "Branch Wise FI Trend.csv";  // Replace with the actual file name
    ...
    public void CSVRowCount() {
        ...
        String csvFilePath = "src/file_download/Branch Wise FI Trend.csv";
    ...
    public void removeDownloadedCSVFiles() {
        String fileToDelete = "Branch Wise FI Trend.csv";
        String path = "src/file_download";
        String filePath = path + File.separator + fileToDelete;
        File file = new File(filePath);
        try {
