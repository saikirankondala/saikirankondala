...
public class Graphs_BranchWiseSales  extends Utils {
    By Collection_menu = By.xpath("/html/body/div/div[1]/div[4]/div/div/div[3]/div/div[2]/div/div/div/div[4]/div[1]");
    By Download_SVG = By.xpath("/html/body/div/div[1]/div[4]/div/div/div[3]/div/div[2]/div/div/div/div[4]/div[2]/div[1]");
    By Download_PNG = By.xpath("/html/body/div/div[1]/div[4]/div/div/div[3]/div/div[2]/div/div/div/div[4]/div[2]/div[2]");
    By Download_CSV = By.xpath("/html/body/div/div[1]/div[4]/div/div/div[3]/div/div[2]/div/div/div/div[4]/div[2]/div[3]");
    ...
    By Status_Type_FieldInvestigation = By.xpath("//*[@id=\"graphTypeOptions\"]//*[text()='Branch Wise Sales']");

    public void Type_BranchwiseSale()
    {
...
//        click(custom_month_CollectionTrend);
    ...
    public void clickDownloadCSVButton() throws IOException, CustomException {
        ...
        wait(5);
        String downloadFolderPath = "src/file_download";  // Replace with the actual folder path
        String fileName = "Branch Wise Sales Trend.csv";  // Replace with the actual file name
    ...
    public void CSVRowCount() {
        ...
        String csvFilePath = "src/file_download/Branch Wise Sales Trend.csv";
    ...
    public void removeDownloadedCSVFiles() {
        String fileToDelete = "Branch Wise Sales Trend.csv";
        String path = "src/file_download";
        String filePath = path + File.separator + fileToDelete;
        File file = new File(filePath);
        try {
