...
public class Graphs_BranchWiseCollectionsTrend extends Utils
{
   ...
   // By Collection_Type_LegalCase_Trends = By.xpath("//*[@id=\"statusOptions\"]//*[text()='Legal Case']")
    ...
    By Status_Type_BranchWiseCollection=By.xpath("//*[@id=\"graphTypeOptions\"]//*[text()='Branch Wise Collections']");
    ...
    public void clickDownloadCSVButton() throws IOException, CustomException {
        ...
        wait(5);
        String downloadFolderPath = "src/file_download";  // Replace with the actual folder path
        String fileName = "Branch Wise Collections Trend.csv";  // Replace with the actual file name
    ...
    public void CSVRowCount()
    {
        ...
        String csvFilePath = "src/file_download/Branch Wise Collections Trend.csv";
        ...
        try {
            if (file.exists()) {
                    if (file.delete()) {
                        ...
                        {
                            test().log(Status.FAIL,"File '" + fileToDelete + "'  not deleted successfully.");
                        }
                    }
            }
        } catch (NoSuchElementException m) {
    ...
    public void removeDownloadedCSVFiles() {
        String fileToDelete = "Branch Wise Collections Trend.csv";
        String path = "src/file_download";
        String filePath = path + File.separator + fileToDelete;
        File file = new File(filePath);
        try {
    ...
    public void Type_BranchWiseCollection()
    {
        waitforElementToBeClickable(Status_Type_Collections);
        click(Status_Type_Collections);
        waitforElementToBeClickable(Status_Type_BranchWiseCollection);
        click(Status_Type_BranchWiseCollection);
    }
}
