...
public class CpName_Indify extends Utils
{
    ...
    public void DeleteDownloadedXLSX()
    {
        File fileToDelete = new File(fileName_Customer_Details);
