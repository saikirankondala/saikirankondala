...
public class UserManagement_Inactive extends Utils
{
    WebElement EmpName,MobileNo,EmpID,Branch;
    By UserManagement= By.xpath("//*[@id=\"userMgmt1\"]/span");
    By CPuser=By.xpath("//*[@id='inactiveUsers']");
    By SearchBarInManager=By.xpath("//input[@placeholder=\"Search By Name/Emp ID/Email/Mobile\"]");
    By ExecutiveDownloadButton=By.xpath("//*[@id=\"main-wrapper\"]/div[4]/div/div/div[1]/button[2]");
    ...
    {
        waitforElementToBeClickable(CPuser);
        jsClick(CPuser);
    }
...
//    {
//        int rowCount=0;
//        jsClick(ExecutiveDownloadButton);
//        wait(10);
...
//            for (File file : files)
//            {
//                if (file.isFile() && file.getName().startsWith("Clu_Executive"))
//                {
//                    System.out.println("Found file: " + file.getAbsolutePath());
//                    test().log(Status.PASS, "=====>CPUser File has been downloaded successfully.");
//                }
//            }
//        }
//        else
...
//            test().log(Status.FAIL, "=====>CPUser File download verification failed.");
//        }
//    }
...
//            {
//                test().log(Status.PASS, "=====>Executive Pagenation "+ManagerCounts+" count is matched with the XLS File downloaded File Row count "+Manager_XLSVRowCount);
//                System.out.println("Executive Pagenation "+ManagerCounts+" count is matched with the XLS File downloaded File Row count "+Manager_XLSVRowCount);
//
//            }
//            else
//            {
//                test().log(Status.FAIL, "=====>Executive Pagenation "+ManagerCounts+" count is not matched with the XLS File downloaded File Row count "+Manager_XLSVRowCount);
//                System.out.println("Executive Pagenation "+ManagerCounts+" count is not matched with the XLS File downloaded File Row count "+Manager_XLSVRowCount);
//
//            }
//        }
//        else
//        {
//            test().log(Status.FAIL, "Issue In the Executive Downloaded XLSV file");
//
//        }
//
//    }
    ...
    {
        List<WebElement> rows = getElementsList(By.xpath("//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr/td[5]"));
        int BranchNameCount= rows.size();
        int i= getRandomNumber(1,BranchNameCount);
        String BranchNameInManagerTab = "//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr[" + i + "]/td[5]";
    ...
    public void FetchResultedSearchOfBranchName()
    {
        try
        {
            String BranchNameResultedRecord="//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr[1]/td[5]";
        ...
        {
            test().log(Status.PASS,"=====>Searched Email "+BranchName+" is matched");
        }
        else
        {
            test().log(Status.FAIL,"=====>Searched Email "+BranchName+" is not matched");
        }
    ...
    public void FetchMobileNoName() {
        List<WebElement> rows = getElementsList(By.xpath("//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr/td[6]"));
        int MobileNoCount= rows.size();
        int i= getRandomNumber(1,MobileNoCount);
        String MobileNoInManagerTab = "//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr[" + i + "]/td[6]";
    ...
    public void FetchResultedSearchOfMobileNo()
    {
        try
        {
            String MobileNoInResultedRecord="//*[@id=\"main-wrapper\"]/div[4]/div/div/div[2]/div/div[1]/div/table/tbody/tr[1]/td[6]";
            By MobilenoInResultedRecord=By.xpath(MobileNoInResultedRecord);
            WebElement resultedmobileInManagerTab = getElement(MobilenoInResultedRecord);
            ResultedMobileNoInManagerTab=resultedmobileInManagerTab.getText();
