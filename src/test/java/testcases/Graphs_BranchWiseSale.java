...
public class Graphs_BranchWiseSale extends Utils
{
    ...
    @Test(testName = "Verify  Branch Wise Sales Graphs  In CluCloud Application ")
    public void verifyCluHomePage_graphs() throws IOException, CustomException {
        ...
        Pages.graphs_branchWiseSales().Type_BranchwiseSale();
        Reporter.log("Step 3: Selected branchWiseSales in trends", true);

        Pages.graphs_branchWiseSales().Collection_7DaysFilter();
        Reporter.log("Step 4: Selected Last 7 Days Filter In branchWiseSales Trends", true);

        Pages.graphs_branchWiseSales().clickDownloadSVGButton();
        Reporter.log("Step 5: Downloaded SVG file in collection ", true);

        Pages.graphs_branchWiseSales().clickDownloadPNGButton();
        Reporter.log("Step 6: Downloaded PNG file in collection ", true);

        Pages.graphs_branchWiseSales().clickDownloadCSVButton();
        Reporter.log("Step 7: Downloaded CSV file in collection ", true);

        Pages.graphs_branchWiseSales().CSVRowCount();
        Reporter.log("Step 8:  RowCount of CSV and fields in CSV ", true);

        Pages.graphs_branchWiseSales().removeDownloadedPNGFiles();
        wait(2);
        Pages.graphs_branchWiseSales().removeDownloadedSVGFiles();
        wait(2);
        Pages.graphs_branchWiseSales().removeDownloadedCSVFiles();
        wait(2);
        Reporter.log("Step 9:  Succesfully Removed Downloaded File from Root path ", true);

//---------------------------------Selected Custom month Date Range<----------------------------------------//
        Pages.graphs_branchWiseSales().CurrentMonth_Filter();
        Reporter.log("Step 10:  Selected Current Month Filter In branchWiseSales Trends ", true);
        ...
        Pages.graphs_branchWiseSales().LastMonth_Filter();
        Reporter.log("Step 16:  Selected Last Month Filter In branchWiseSales Trends ", true);
...
//---------------------------------Selected last 6 month Date Range<----------------------------------------//
        ...
        Pages.graphs_branchWiseSales().Last6Month_Filter();
        Reporter.log("Step 22:  Selected Last 6 Month Filter In branchWiseSales Trends ", true);
        ...
        Pages.graphs_branchWiseSales().CustomMonths_Collection_Trends_Filter();
        Reporter.log("Step 28:  Selected Custom Month Filter In branchWiseSales Trends ", true);
