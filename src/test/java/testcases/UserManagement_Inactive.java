...
public class UserManagement_Inactive extends Utils {
    ...
    @Test(retryAnalyzer = Rerunautomation.class,testName = "Verify userManagement_Inactive search bar  In CluCloud Application ")
    public void verifyCluuserManagement_Inactive() throws Exception, CustomException
    {
        ...
        Reporter.log("Step 5: Click on Inactive user Tab Management tab in Clu", true);

        Pages.userManagement_cPuser().FetchEmployeeName();
        Reporter.log("Step 6: Fetch Random Employee Name at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().ClickOnSearchBar();
        Reporter.log("Step 7: Click on Search Bar at Inactive User Tab in User Management tab in Clu", true);
        ...
        Reporter.log("Step 9: Fetch Random Branch Name at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().ClickOnSearchBarForBranchName();
        Reporter.log("Step 10: Click on Search Bar at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().FetchResultedSearchOfBranchName();
        Reporter.log("Step 11: Compare the resulted branch Name with entered branch name  at Inactive User Tab in User Management tab in Clu", true);
        driver.get().navigate().refresh();

        Pages.userManagement_cPuser().FetchEMPIDName();
        Reporter.log("Step 12: Fetch Random EmpID at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().ClickOnSearchBarForEMPID();
        Reporter.log("Step 13: Click on Search Bar at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().FetchResultedSearchOfEMPID();
        Reporter.log("Step 14: Compare the resulted empID with entered empId  at Inactive User Tab in User Management tab in Clu", true);
        driver.get().navigate().refresh();

        Pages.userManagement_cPuser().FetchMobileNoName();
        Reporter.log("Step 15: Fetch Random Mobile No at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().ClickOnSearchBarForMobileNo();
        Reporter.log("Step 16: Click on Search Bar at Inactive User Tab in User Management tab in Clu", true);

        Pages.userManagement_cPuser().FetchResultedSearchOfMobileNo();
        Reporter.log("Step 17: Compare the resulted MobileNo with entered MobileNo  at Inactive User Tab in User Management tab in Clu", true);
        driver.get().navigate().refresh();
