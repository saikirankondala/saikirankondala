...
public class AllocatedUsersSearchBar_CPName_BAJAJFINANCE extends Utils {
    ...
    @Test(testName = "Verify Bajaj Finance work allocation   In CluCloud Application ")
